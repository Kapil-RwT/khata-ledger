package com.khataledger.common;
...
/**
 * Centralized error -> RFC 7807 ProblemDetail mapper.
 * Pattern: every exception in the system surfaces as a structured JSON error,
 * never a raw stack trace. Single source of truth for HTTP semantics.
 */
